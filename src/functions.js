...
let layout1 = val => {
    return {
        ...
        content: [
                ...
                table: {
                    body: [
                        [
                            ...
                            {
                                stack: [
                                    labelText(val.labelInvoice, val.colorPrimary, ["h1", "left", "bold"]),
                                    labelText(val.labelInvoiceNum, val.colorPrimary, ["h3", "left", "marginV10"]),
                                    labelText(val.invoiceNum, "", ["h2", "left", "marginV5"]),
                                    labelText(val.labelInvoiceDate, val.colorPrimary, ["h3", "left", "marginV10"]),
                                    labelText(val.invoiceDate, "", ["h2", "left", "marginV5"]),
                                    labelText(val.labelDueDate, val.colorPrimary, ["h3", "left", "marginV10"]),
                                    labelText(val.dueDate, "", ["h2", "left", "marginV5"])
                                ]
                            },
                            {
                                stack: [
                                    labelText(val.labelBillingFrom, val.colorPrimary, ["h3", "left", "marginV10"]),
                                    labelText(
                                        val.sellerName +
                                            "\n" +
                                            val.sellerCompany +
                                            ...
                                            "\n" +
                                            val.sellerAddressLine5,
                                        "",
                                        ["h4", "left"]
                                    ),
                                    labelText(val.labelBillingTo, val.colorPrimary, ["h3", "left", "marginV10"]),
                                    labelText(
                                        val.clientName +
                                            "\n" +
                                            val.clientCompany +
            ...
            {
                text: "This para goes below all columns and has full width",
                fontSize: 12
            },
            { text: "This para goes below all columns and has full width" }
            // verticalDivider(),
