            ...
            [
              ...
              {},
              {
                stack: [
                  ...
                  labelText(val.invoiceNum, "", ["h2", "left", "bMarginLG"]),
                  labelText(val.labelInvoiceDate, val.colorPrimary, [
                    "h3",
                    "left",
                    "bMarginLG"
                  ]),
                  labelText(val.invoiceDate, "", ["h2", "left", "bMarginLG"]),
                  labelText(val.labelDueDate, val.colorPrimary, [
                    "h3",
                    "left",
                    "bMarginLG"
                  ]),
                  labelText(val.dueDate, "", ["h2", "left", "bMarginLG"])
                ]
              },
              {},
              {
